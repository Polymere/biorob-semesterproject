...
class EvolutionController():
	...
	def cross_and_mutate(self,selected_parents):
		...
		print("\n",couples)
		p1_ids=selected_parents.iloc[couples[0][:]].uid.values
		p2_ids=selected_parents.iloc[couples[1][:]].uid.values
		print("\nParents",p1_ids,"\tP2",p2_ids)
		#print(self.current_pop[p1_ids])
		for child in range(self.nb_ind):
			print("\n-------------------------------")
			print(self.current_pop[p1_ids[child]])
			print(self.current_pop[p2_ids[child]])
		raise NotImplementedError
	...
	def eval_pop(self,population):
		if NORUNMODE:
			...
			self.run_launcher.create_pop(population,self.param_paths,self.log_paths,str(self.nb_gen))
			#print("\n[DEBUG] Eval pop\n",scores)
